...
const CoupleEveningApp = () => {
  ...
  const activities = [
    {
      title: "Interrogation Program", // ex "Gioco delle Domande"
      description:
    ...
    {
      title: "Training Program", // ex "Sfida di Coppia"
      description:
    ...
    {
      title: "Construct Program", // ex "Momento Romantico"
      description:
  ...
  const getNextItem = (activity) => {
    ...
    // Aggiorna l'indice e il contenuto
    setCurrentIndex((prev) => ({
      ...prev,
      [category]: nextIndex,
    }));

    // Aggiorna il contenuto con il nuovo item
  ...
  // Aggiorna i progressi solo se non siamo alla fine
  if (nextIndex < items.length) {
    updateProgress();
  } else {
    // Opzionale: gestisci il completamento della categoria
      ...
      <div style={styles.content}>
        ...
        <div style={styles.statsContainer}>
          ...
          <div style={{ marginTop: "0.5rem" }}>
            <Zap size={16} color="#00ff00" style={{ marginRight: "0.5rem" }} />
